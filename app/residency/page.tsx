...
export default function Residency() {
  ...
  return (
    <main className="min-h-screen bg-[#040423] text-white">
      ...
      {/* Program Overview */}
      <section id="program" className="py-20 bg-[#040423]">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 text-center">
              <Link
                href="/apply"
                className="inline-block px-12 py-6 bg-[#EF400A] text-white rounded-full text-xl font-semibold hover:bg-[#ff5a2b] transition-colors"
              >
