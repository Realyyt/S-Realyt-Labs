        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#" className="text-gray-400 hover:text-[#EF400A] text-sm">For Founders</a>
              <a href="/" className="text-gray-400 hover:text-[#EF400A] text-sm">FAQ</a>
              <a href="/Investors" className="text-gray-400 hover:text-[#EF400A] text-sm">Investment Process</a>
              <a href="/apply" className="text-gray-400 hover:text-[#EF400A] text-sm">Apply</a>
            </div>
          </div>
